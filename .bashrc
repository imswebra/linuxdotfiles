...
# Use Docker image for aws-azure-login
#  Note that Docker needs /mnt/c to be symlinked to /c (hence the /c in this
#  alias), and that Docker can only access Windows's filesystem, so the
